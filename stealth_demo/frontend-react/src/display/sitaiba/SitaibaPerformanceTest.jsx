...
function SitaibaPerformanceTest() {
  const { 
  ...
  const handleRunPerformanceTest = useCallback(async (e) => {
    ...
    try {
      ...
      setLocalError('SITAIBA performance test failed: ' + err.message)
    } finally {
  ...
  const getOutputContent = () => {
    ...
    if (selectedResultIndex >= 0 && testResults[selectedResultIndex]) {
      ...
      return `🏁 SITAIBA Scheme Performance Test Results - Test ${selectedResultIndex}
...
• DSK Generation: ${latestResult.onetime_sk_ms}ms
• Identity Tracing: ${latestResult.trace_ms}ms

💡 SITAIBA does not support signing features`
    }
    
    return 'Configure test parameters and run SITAIBA scheme performance analysis...'
  }
  ...
  return (
    <Section title="📊 Performance Test (SITAIBA)" className="performance-section">
      <div className="controls">
        ...
        <div className="test-controls">
          <Button
            ...
            type="button"
          >
            {localLoading.testing ? 'Running Test...' : 'Run SITAIBA Performance Test'}
          </Button>
        ...
        {localLoading.testing && (
          <div className="progress-indicator">
            ...
            <div className="progress-text">
              Running {iterations} SITAIBA cryptographic operation iterations...
            </div>
          </div>
        )}
      </div>
        ...
        <div className="performance-grid">
          {selectedResultIndex >= 0 && testResults[selectedResultIndex] && (
            <>
              ...
              <div className="perf-metric">
                <div className="perf-value">{testResults[selectedResultIndex].onetime_sk_ms}ms</div>
                <div className="perf-label">DSK Generation</div>
              </div>
              <div className="perf-metric">
              ...
              <div className="perf-metric">
                <div className="perf-value">Not Supported</div>
                <div className="perf-label">Signing Features</div>
              </div>
            </>
          )}
        </div>
...
export default SitaibaPerformanceTest